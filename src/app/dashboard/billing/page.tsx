...
export default function BillingPage(){
    return <div className="mx-auto flex  flex-col space-y-8 px-4 py-12">
        <div className="flex relative items-center justify-center gap-4">
            ...
            <div className="space-y-2 text-center">
                <h1 className="text-2xl font-bold tracking-tight sm:text-4xl">Buy Credits</h1>
                <p className="text-muted-foreground">Purchase credits to generate more podcast clips. The more credits you buy , the better the value</p>
            </div>
        </div>
